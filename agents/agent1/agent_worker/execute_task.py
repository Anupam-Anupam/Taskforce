...
async def execute_task_async(task_description: str, task_id: Optional[int] = None, mongo_client: Optional[Any] = None) -> dict:
    ...
    try:
        ...
        try:
            ...
            system_prompt = """You are Agent 1, a highly capable AI assistant with access to a Linux desktop environment through computer use tools. You can interact with the desktop, browse the web, run commands, and complete complex tasks.
                        ...
                        if item_type == "message":
                            ...
                            for cp in content_parts:
                                ...
                                if text:
                                    ...
                                    print(f"Agent: {text}")
                                    # Commented out to prevent duplicate logging (final response logged in runner.py)
                                    # if mongo_client:
